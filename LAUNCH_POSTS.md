...
Free tier: 10 req/min. Apache 2.0 licensed. 663 tests for core package, 107 for API.
...
Apache 2.0 licensed. Would love feedback from practicing chemists on what would make this more useful.
...
Solo project, Apache 2.0 licensed.
...
The API is free for personal use (10 req/min). Apache 2.0 licensed so you can fork and extend.
