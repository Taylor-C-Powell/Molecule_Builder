...
def generate_3d_coordinates(lewis: LewisStructure) -> dict:
    ...
    for bond in lewis.bonds:
        ...
        bl = estimated_bond_length_angstrom(lewis.central_symbol, sym, bond.order)
...
if __name__ == "__main__":
    print("VSEPR Theory -- Molecular Geometry Prediction\n")
    ...
    molecules = [
        ...
        ("SF4",  0, "Seesaw"),
        ("ClF3", 0, "T-shaped"),
        ("XeF2", 0, "Linear (3 lone pairs)"),
        ("SF6",  0, "Octahedral"),
        ("IF5",  0, "Square pyramidal"),
        ("XeF4", 0, "Square planar"),
    ]

    for formula, charge, description in molecules:
        print(f"--- {description} ---")
