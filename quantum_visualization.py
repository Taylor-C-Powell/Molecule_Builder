...
TEXT_COLOR = "#ccddee"
GRID_COLOR = "#1a2a3a"
POSITIVE_COLOR = "#3399ff"   # positive lobe of wave function
NEGATIVE_COLOR = "#ff5533"   # negative lobe
...
if __name__ == "__main__":
    from quantum_model import QuantumAtom, from_symbol
    ...
    # Individual plots
    print("1) Radial probability distributions for Carbon")
    plot_radial_probability([(1, 0), (2, 0), (2, 1)], Z=6)

    print("2) Radial wave functions for Hydrogen n=1,2,3")
    plot_radial_wavefunction([(1, 0), (2, 0), (2, 1), (3, 0), (3, 1), (3, 2)], Z=1)

    print("3) Angular distribution for d_z2 orbital")
    plot_angular_distribution(2, 0)

    print("4) 3D orbital: Carbon 2p_z")
    plot_orbital_3d(2, 1, 0, Z=6)

    print("5) Full atom overview for Iron")
    iron = from_symbol("Fe")
    visualize_atom(iron, orbital_nlm=(3, 2, 0))
