...
existing quantum_visualization module.
...
from element_data import cpk_color, covalent_radius_pm
from vsepr_model import VSEPRMolecule

# ===================================================================
# Theme (matching quantum_visualization.py)
# ===================================================================
BG_COLOR = "#0a0a1a"
TEXT_COLOR = "#ccddee"
GRID_COLOR = "#1a2a3a"
...
if __name__ == "__main__":
    print("VSEPR Molecule Visualization Demo\n")

    # Single molecule detail view
    water = VSEPRMolecule("H2O")
    print(water.summary())
    print("\nVisualising H2O...")
    visualize_molecule(water)

    # Gallery of common geometries
    print("\nVisualising geometry gallery...")
    gallery = [
        VSEPRMolecule("BeCl2"),  # linear
        VSEPRMolecule("BF3"),    # trigonal planar
        VSEPRMolecule("CH4"),    # tetrahedral
        VSEPRMolecule("NH3"),    # trigonal pyramidal
        VSEPRMolecule("H2O"),    # bent
        VSEPRMolecule("PCl5"),   # trigonal bipyramidal
        VSEPRMolecule("SF4"),    # seesaw
        VSEPRMolecule("SF6"),    # octahedral
        VSEPRMolecule("XeF4"),   # square planar
    ]
    visualize_gallery(gallery)
