"""
Welcome to Molecule Builder!

Molecule Builder is a tool for building and visualizing molecules.
...
All code is regarded as the intellectual Property of the above contributors.
Use responsibly.
"""
...
def demo_bohr_model():
    ...
    from bohr_model import BohrAtom, from_symbol
...
def demo_quantum_model():
    ...
    from quantum_model import QuantumAtom, from_symbol, aufbau_order
...
def demo_molecular_conformations():
    ...
    from molecular_conformations import (
        ...
        build_chiral_molecule, classify_conformation, scan_torsion,
        RingConformation,
    )
...
def demo_amino_acids():
    ...
    from molecular_conformations import Molecule, Hybridization, SP3_ANGLE
...
def demo_visualization():
    ...
    from vsepr_model import VSEPRMolecule
    from molecule_visualization import visualize_molecule, visualize_gallery
...
def demo_quantum_visualization():
    ...
    from quantum_model import from_symbol as q_from_symbol
